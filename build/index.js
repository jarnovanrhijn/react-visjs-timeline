...
var events = ['currentTimeTick', 'click', 'contextmenu', 'doubleClick', 'groupDragged', 'changed', 'rangechange', 'rangechanged', 'select', 'timechange', 'timechanged', 'mouseOver', 'mouseMove', 'mouseDown', 'mouseUp', 'itemover', 'itemout'];
...
function optionsAreEqual(options1, options2) {
  return options1.template === options2.template && options1.horizontalScroll === options2.horizontalScroll && options1.maxHeight === options2.maxHeight && options1.minHeight === options2.minHeight && options1.showCurrentTime === options2.showCurrentTime && options1.width === options2.width && options1.zoomable === options2.zoomable && options1.editable === options2.editable;
}
  ...
  _createClass(Timeline, [{
    ...
    value: function shouldComponentUpdate(nextProps) {
      ...
      if (optionsChange) {
        var _nextProps$options = nextProps.options,
            ...
            rest = _objectWithoutProperties(_nextProps$options, ['start', 'end']);

        this.updateOptions(rest);
      }

      var customTimesChange = !customTimesAreEqual(customTimes, nextProps.customTimes);
    ...
    value: function init() {
      ...
      var _props3 = this.props,
          ...
          selectionOptions = _props3$selectionOpti === undefined ? {} : _props3$selectionOpti,
